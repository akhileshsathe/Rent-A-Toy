...
class UserOrders : AppCompatActivity() {
    ...
    private lateinit var adapter: UserOrderAdapter // Create an OrderAdapter class
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = UserOrderAdapter(filteredOrderList) // Create an OrderAdapter instance
    ...
    private fun fetchDataFromRealtimeDatabase() {
        ...
        val ordersRef = database.getReference("Orders")
            .orderByChild("isReturned").equalTo(false)
