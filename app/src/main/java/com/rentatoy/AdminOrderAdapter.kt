...
class AdminOrderAdapter(private val orderList: List<OrderHelper>) : RecyclerView.Adapter<AdminOrderAdapter.OrderViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OrderViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { view ->
            val intent = Intent(view.context, AdminOrderDetails::class.java)
